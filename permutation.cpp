...
int main()
{
	...
	is_permutation(first, last, first2, compb);			// (F, F, F, 2)		bool	compb
	is_permutation(first, last, first2, last2);			// (F, F, F, F)		bool	==
	is_permutation(first, last, first2, last2, compb);	// (F, F, F, F, 2)	bool	compb
	...
	next_permutation(first, last, compb);		// (B, B, 2)	bool	compb
	...
	prev_permutation(first, last, compb);		// (B, B, 2)	bool	compb
